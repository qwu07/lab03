...
author: "YIRAN LI, Esther Wang, Hong Ding, Queency Wu, Liu Fangyao and Jin Yicheng - Code Breakers"
...
Wide Format: One row per ID, multiple columns.
Long Format: Multiple rows in each ID, and one column.
